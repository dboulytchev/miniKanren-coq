...
| esInvoke       : forall r arg     s cs       n, eval_step (Leaf (Invoke r arg) s cs n) Step (State (Leaf (proj1_sig (MiniKanrenSyntaxDiseq.Prog r) arg) s cs n))
...
Proof.
  ...
  { constructor. constructor; auto.
    specialize (proj2_sig (MiniKanrenSyntaxDiseq.Prog r)). intro CC.
