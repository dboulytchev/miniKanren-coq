...
| dsst'SumL : forall m st1' st2' f (DSST' : in_denotational_sem_state' st1' f),
                                   in_denotational_sem_state' (Sum m st1' st2') f
| dsst'SumR : forall m st1' st2' f (DSST' : in_denotational_sem_state' st2' f),
                                   in_denotational_sem_state' (Sum m st1' st2') f
