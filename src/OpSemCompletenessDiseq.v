...
Proof.
  ...
  { induction g; intros; good_inversion CG.
    ...
    { good_inversion DSG. good_inversion OP. inversion EV; subst.
      apply well_formedness_preservation in EV; auto. good_inversion EV. simpl_existT_cs_same.
      assert (cg_body : consistent_goal (proj1_sig (MiniKanrenSyntaxDiseq.Prog n) t)).
      { remember (MiniKanrenSyntaxDiseq.Prog n) as d. destruct d as [rel [Hcl Hco]].
        red in Hco. destruct (Hco t) as [Hcog Hcof]. auto. }
      specialize (IHl (proj1_sig (MiniKanrenSyntaxDiseq.Prog n) t) f s n0 cs cg_body DSG0 DSS DSCS wfState t1 OP0).
